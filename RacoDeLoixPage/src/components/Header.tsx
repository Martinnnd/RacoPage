...
const Header = () => {
    ...
    return (
        <>
            ...
            {/* 🔲 Overlays */}
            {menuOpen && <div onClick={() => setMenuOpen(false)} className="fixed inset-0 z-30  bg-opacity-40 backdrop-blur-sm" />}
            {cartOpen && <div onClick={() => setCartOpen(false)} className="fixed inset-0 z-30  bg-opacity-40 backdrop-blur-sm" />}
            {submenuOpen && <div onClick={() => setSubmenuOpen(false)} className="fixed inset-0 z-30  bg-opacity-40 backdrop-blur-sm" />}
        </>
    );
};
